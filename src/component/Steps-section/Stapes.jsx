    ...
    return (
        <div className='max-w-300 mx-auto my-50'>
           <div className='text-center mb-6'>
            ...
            <p className='text-gray-300'>Start using premium digital tools in minutes, not hours.</p>
           </div>
            <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-6'>
                <div className="card p-4 bg-base-100 shadow-sm">
            <div className="card-body ">
                <div className='flex justify-end'>
                <div className='h-10 w-10 bg-green-500 rounded-full py-[10.5px] px-[11px]'><p>02</p></div>
                    
                </div>
                
            </div>
            <div className='flex justify-center'>
                <div className='h-[99px] w-25 bg-amber-200 rounded-full p-5 '>
